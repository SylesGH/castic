    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8">
        <header className="mb-8">
          <h1 className="text-4xl font-bold text-center text-foreground mb-2 poppins">My Cards</h1>
          <p className="text-center text-muted-foreground">Create, view, and manage your collection of cards with images, titles, and more.</p>
        </header>

        <SearchBar query={query} onQueryChange={setQuery} onFilterClick={handleFilterClick} />

        <main>
          <GalleryGrid cards={galleryData} size={currentSize} searchQuery={debouncedQuery} />
        </main>

        <SizeToggle currentSize={currentSize} onSizeChange={cycleSize} />
      </div>
    </div>
  )
}
